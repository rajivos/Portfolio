      ...
      <Container text>
        ...
        <center>
          <Transition nimation={"fade"} duration={2700} visible={visible}>
            <div><Button primary  size="big" >Resume</Button> <Button positive size="big" >Projects</Button></div>
          </Transition>
        </center>
      </Container>
    );
              ...
              <Menu fixed={fixed ? "top" : null} inverted={true} size="large">
                ...
                <Transition
                  ...
                  <Transition
                    ...
                    animation="fade down"
                    duration={1500}
                  ><Menu.Item as="a">Work</Menu.Item></Transition>
                  <Transition
                    visible={calculations.topPassed}
                    animation="scale"
                    duration={1500}
            ...
            <Segment style={{ padding: "8em 0em" }} vertical>
              <Container text>
                ...
                <p style={{ fontSize: "1.33em" }}>
                  ...
                  massive amounts of whitespace and generic content that can
                  seem massive, monolithic and worth your attention.
                </p>
